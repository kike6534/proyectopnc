<!DOCTYPE html>
<html>
<div class="modal fade text-left" id="md_educacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title white" id="myModalLabel16">Educación
                </h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group has-icon-left">
                                <label for="Id-icon">Titulo obtenido</label>
                                <input type="text" class="form-control" placeholder="Licenciado en contaduria" id="Apellido-icon">
                            </div>

                            <label for="Id-icon">Institución</label>
                            <div class="input-group">
                                <select class="form-select">
                                    <option value="square">Seleccione...</option>
                                    <option value="square">Universidad de EL Salvador</option>
                                    <option value="square">Universidad Panamericana</option>
                                    <option value="square">ANSP</option>
                                </select>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#md_addinstituciones" type="button" id="inputGroupFileAddon04">Agregar</button>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group has-icon-left">
