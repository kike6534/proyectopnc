...
function cargar_dona(){
    ...
    $.ajax({
        dataType: "json",
        method: "POST",
        url: base_url+"/Consultas/selectAgentesPromocioncount1"
...
function cargar_datos(){
    ...
    $.ajax({
        dataType: "json",
        method: "POST",
        url: base_url+"/Consultas/getAgentesPorPromocion",
        data : datos,
    }).done(function(json) {
        console.log("EL consultar",json);
        $("#datos_tabla_agentes").empty().html(json.htmlDatosTabla);
        inicializar_tabla("tableAgentes");
    }).fail(function(){
